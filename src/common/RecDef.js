...
var Metadata = {
	...
	{name:'source',
	 ...
	 toHtml:(s)=>s&&`<span><a href=${s.url}>${s.name||s.url.substr(0,30)}</a></span>`,
         edit:LNK,
        },
	{name:'preptime',
	 label:'Prep Time',
         testValue:{seconds:4250},
	 toHtml:(s)=>s.text||Units.secondsToTimeString(s.seconds),
         edit:DUR,
        },
	{name:'cooktime',
	 label:'Time to Cook',
         testValue:{seconds:14250},
	 toHtml:(s)=>s.text||Units.secondsToTimeString(s.seconds),
         edit:DUR,
        },
	{name:'totaltime',
