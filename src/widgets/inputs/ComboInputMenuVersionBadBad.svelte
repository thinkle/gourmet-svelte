<script>
 ...
 import {IconButton,Menu,MenuItem} from '../index.js';
 ...
 let showAll
 let menuComponent
 /* $: showMenu && menuComponent && menuComponent.showMenu()
  * $: !showMenu && menuComponent && menuComponent.hideMenu() */
...
<span class='cmb' bind:clientWidth="{widgetWidth}">
