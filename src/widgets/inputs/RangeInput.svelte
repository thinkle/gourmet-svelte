...
<span class:buttonMode={showPlusMinusButtons}>
    ...
    {#if showPlusMinusButtons}
        <div class="minibuttons">
            <IconButton fontSize="0.8rem" compact="{true}" on:click={doIncrement} bare={true} icon="keyboard_arrow_up"></IconButton>
            <IconButton fontSize="0.8rem" compact="{true}" on:click={doDecrement} bare={true} icon="keyboard_arrow_down"></IconButton>
        </div>
    {/if}
</span>
</Underline>
