...
const UNIT_CONVERSIONS = [
  // American volume
  { bigger: "tsp", smaller: "drop", multiplier: 76 },
  { bigger: "Tbs", smaller: "tsp", multiplier: 3 },
  { bigger: "fl oz", smaller: "Tbs", multiplier: 2 },
  { bigger: "c", smaller: "fl oz", multiplier: 8 },
  { bigger: "pt", smaller: "c", multiplier: 2 },
  { bigger: "qt", smaller: "c", multiplier: 4 },
  { bigger: "gallon", smaller: "qt", multiplier: 4 },
  // Dry units...
  { bigger: "bucket", smaller: "peck", multiplier: 2 },
  { bigger: "bushel", smaller: "bucket", multiplier: 2 },

  // American weights
  { bigger: "lb", smaller: "oz", multiplier: 16 },
  { bigger: "oz", smaller: "dram", multiplier: 16 },
  { bigger: "lb", smaller: "grains", multiplier: 7000 },

  // {bigger:"l",
  //  smaller:"qt",
  //  multiplier:1.057},
  { bigger: "Japanese cup", smaller: "ml", multiplier: 200 },
  // Other cups...
  { bigger: "metric cup", smaller: "ml", multiplier: 250 },
  { bigger: "Imperial cup", smaller: "ml", multiplier: 284.130625 },
  { bigger: "Imperial pint", smaller: "oz", multiplier: 20 },

  // Metric volumes
  { bigger: "l", smaller: "ml", multiplier: 1000 },
  { bigger: "l", smaller: "cl", multiplier: 100 },
  { bigger: "l", smaller: "dl", multiplier: 10 },

  // Metric weights
  { bigger: "kg", smaller: "g", multiplier: 1000 },
  { bigger: "g", smaller: "mg", multiplier: 1000 },

  // Metric to American/Imperial...
  { bigger: "oz", smaller: "g", multiplier: 28.35 },
  { bigger: "fl oz", smaller: "ml", multiplier: 29.5735 },
  // Don't define peck in terms of gallons --
  // it's in terms of dry gallons, which maybe aren't even a real
  // US standard?
  { bigger: "peck", smaller: "l", multiplier: 8.809 },
...
UNIT_NAMES.sort();
export const UNIT_REGEXP_STRING =
  "\\b(" + UNIT_NAMES.map(reEscape).join("|") + "[.]?)(\\b|$)"; // FF doesn't support named regexps :(
export const UNIT_REGEXP = new RegExp(UNIT_REGEXP_STRING, "i");
...
export function addAmounts(amounts, item) {
  ...
  return Object.keys(byUnit).map((unit) => ({
    unit,
    amount: byUnit[unit],
  }));
}
